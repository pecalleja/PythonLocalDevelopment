...
| [Balanced Binary Tree](https://leetcode.com/problems/balanced-binary-tree)                                                                           | Easy       | [balanced_binary_tree.py](trees/balanced_tree.py)                                          |
...
| [Binary Tree Level Order Traversal](https://leetcode.com/problems/binary-tree-level-order-traversal)                                                 | Medium     | [levelorder_traversal.py](trees/levelorder_traversal.py)                                   |
...
| [Validate Binary Search Tree](https://leetcode.com/problems/validate-binary-search-tree)                                                             | Medium     | [valid_tree.py](../codesignal/trees/valid_tree.py)                                         |
